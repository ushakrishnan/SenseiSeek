...
export function InboxClient({ initialConversationId }: { initialConversationId?: string | null }) {
        ...
        return (
            <Card className="text-center py-12">
                <CardHeader>
                    ...
                    <CardDescription>When you contact executives, your conversations will appear here.</CardDescription>
                </CardHeader>
            </Card>
        );
    }
