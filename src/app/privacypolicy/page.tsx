            ...
            <div className="container mx-auto px-4 max-w-4xl">
                 <div className="space-y-12">
                    <div>
                     ...
                     <div>
                        <h2 className="text-3xl font-bold font-headline mb-4 text-primary">1. Information We Collect</h2>
                        <div className="space-y-4 text-lg text-muted-foreground">
                            <p>
                     ...
                     <div>
                        <h2 className="text-3xl font-bold font-headline mb-4 text-primary">2. How We Use Your Information</h2>
                        <div className="space-y-4 text-lg text-muted-foreground">
                            <p>
                    ...
                    <div>
                        <h2 className="text-3xl font-bold font-headline mb-4 text-primary">3. Disclosure of Your Information</h2>
                        <div className="space-y-4 text-lg text-muted-foreground">
                            <p>
                    ...
                    <div>
                        <h2 className="text-3xl font-bold font-headline mb-4 text-primary">4. Security of Your Information</h2>
                        <div className="space-y-4 text-lg text-muted-foreground">
                            <p>
                    ...
                    <div>
                        <h2 className="text-3xl font-bold font-headline mb-4 text-primary">5. Your Rights and Options</h2>
                        <div className="space-y-4 text-lg text-muted-foreground">
                            <p>
                    ...
                    <div>
                        <h2 className="text-3xl font-bold font-headline mb-4 text-primary">6. Contact Us</h2>
                        <div className="space-y-4 text-lg text-muted-foreground">
                            <p>
